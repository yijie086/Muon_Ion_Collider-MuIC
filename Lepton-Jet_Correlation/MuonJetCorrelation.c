...
void MuonJetCorrelation() {
	...
	hist9t11->SetXTitle("|#phi^{jet}-#phi^{muon}-#pi|");
	...
	legend->AddEntry(hist9t11,"9GeV/c<p_{T}^{muon}<11GeV/c","l");
	legend->AddEntry(hist18t22,"18GeV/c<p_{T}^{muon}<22GeV/c","l");
	legend->AddEntry(hist45t55,"45GeV/c<p_{T}^{muon}<55GeV/c","l");
	legend->AddEntry(hist80t120,"80GeV/c<p_{T}^{muon}<120GeV/c","l");
	legend->Draw();
}
