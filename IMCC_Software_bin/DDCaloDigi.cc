...
void DDCaloDigi::init() {
  ...
  if(_histograms){
    fEcal    = new TH1F("fEcal", "Ecal time profile",1000, -50.0, 50.0);
    fHcal    = new TH1F("fHcal", "Hcal time profile",1000, -50.0, 50.0);

    fEcalC    = new TH1F("fEcalC", "Ecal time profile cor",1000, -20., 20.0);
    fHcalC    = new TH1F("fHcalC", "Hcal time profile cor",1000, -20., 20.0);

    fEcalC1   = new TH1F("fEcalC1", "Ecal time profile cor",100, -20., 20.0);
    fHcalC1   = new TH1F("fHcalC1", "Hcal time profile cor",100, -20., 20.0);

    fEcalC2   = new TH1F("fEcalC2", "Ecal time profile cor",10, -20., 20.0);
    fHcalC2   = new TH1F("fHcalC2", "Hcal time profile cor",10, -20., 20.0);
    ...
    fHcalE2TOF = new TH2F("fHcalE2TOF", "Hcal E-TOF hist",100, 0., 100.0,100,0.,1.);
    fHcalE2T = new TH2F("fHcalE2T", "Hcal E-T hist",100, 0., 100.0,100,0.,1.);
	  ...
	  if (caloLayout!=CHT::barrel) calibr_coeff*=_hcalEndcapCorrectionFactor; // more robust, is applied to ALL hits outside of barrel.
		...
		//timei carries the time of the earliest hit within this window
                ...
                if(_histograms){
                  ...
                  fHcalE2TOF->Fill(timei-dt,energyi*calibr_coeff);
                  fHcalE2T->Fill(timei,energyi*calibr_coeff);
		}
